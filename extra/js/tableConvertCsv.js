(function () {
    HTMLTableElement.prototype.getTableToArr = function () {
        var arr = [];
    ...
    HTMLTableElement.prototype.getTableToMap = function () {
        var tr = this.getElementsByTagName('tr');
        var map = [];
        for (var i = 0; i < tr.length; i++) {
            var td = tr[i].getElementsByTagName('td');
    ...
    HTMLTableElement.prototype.getCsvArr = function () {
        var arr = this.getTableToArr();
        var map = this.getTableToMap();
    ...
    HTMLTableElement.prototype.getCsvStrEncode = function () {
    ...
    HTMLTableElement.prototype.download = function (arg) {
        ...
        downloadFile(obj.filename + timestr + '.csv', decodeURIComponent(this.getCsvStrEncode()));
    };
})();